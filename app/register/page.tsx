...
export default function RegisterPage() {
  ...
  useEffect(() => {
    document.title = "Create Account — WorkTime";
  }, []);
    ...
    <div className="relative min-h-screen flex items-center justify-center bg-background px-4 overflow-hidden transition-colors duration-300">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-card-bg border border-card-border shadow-card rounded-2xl p-8 backdrop-blur-md relative overflow-hidden">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-input-bg border border-transparent rounded-xl text-sm text-text-primary placeholder-text-secondary/50 focus:bg-card-bg focus:border-indigo-500/50 outline-none transition-all duration-200"
                />
              </div>
            </div>
          ...
          <Link
            href="/login"
            className="w-full flex items-center justify-center gap-2 py-2.5 px-4 bg-transparent border border-text-secondary/15 hover:border-text-secondary/35 text-text-primary font-semibold rounded-xl text-sm transition-all duration-200 active:scale-[0.98]"
          >
